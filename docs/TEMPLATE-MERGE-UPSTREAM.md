# 📨 Template de Mensagem — Merge de Atualização Upstream
...
Eu **já baixei** os arquivos localmente. Não tente usar git clone ou acessar a internet.

📂 **Diretórios Mapeados:**
- **Nova Versão (Upstream — Referência):** `D:\Onedrive - Douglas\OneDrive\Pessoal\Dodo\Programacao\Git\proxyIA\qwenproxy-att\qwenbridge`
...
- Manifesto de blindagens: `alterações-dodo.md` (raiz da produção)
- Manual de merge: `docs/GUIA-MERGE-DODO.md` (raiz da produção)
- Checklist de sobrevivência: Seção 6 do `GUIA-MERGE-DODO.md` (14 pontos)
...
📜 **Regras Absolutas — Fase de Análise (NÃO EDITE AINDA):**
1. Leia OBRIGATORIAMENTE o `alterações-dodo.md` e o `GUIA-MERGE-DODO.md` antes de qualquer ação.
...
4. Crie um **Relatório de Análise de Diferenças** em Markdown contendo:
   a) O que mudou no upstream (arquivos, funções, comportamentos)
   b) Quais blindagens do checklist (Seção 6 do GUIA) estão em risco de colisão
...
## ✅ Fluxo Pós-Aprovação do Relatório

Após aprovar o relatório da IA, diga apenas:
...
## ⚠️ Fluxo de Emergência (Algo Quebrou Pós-Merge)

Se algo parar de funcionar após o merge, diga:
...
Preciso voltar para o estado anterior. Consulte a Seção 7 do GUIA-MERGE-DODO.md
e execute o rollback do branch dodo/main para o commit anterior ao merge.
```
