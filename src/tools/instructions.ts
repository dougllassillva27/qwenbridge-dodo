import { TOOL_CALL_OPEN, TOOL_CALL_CLOSE } from "./toolcall-tags.ts";
import { buildCompactToolManifest } from "./manifest.ts";
...
10. NEVER use <arg_key>, <arg_value>, <tool_call_arg_key>, <tool_call_section>, <tool_name>, or XML parameter tags. Output strictly standard JSON inside ${TOOL_CALL_OPEN} tags.
11. NEVER use ${thinkOpen}/${thinkClose} tags in your replies.
